...
function cinemaReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case GET_CUMRAPBY_CINEMAS_SUCCESS:
      return {
        ...state,
        dataCumRapByCinemas: action.payload.data,
        isLoading: false,
      };
    ...
    case GET_SHOWTIMESBY_CINEMAS_SUCCESS:
      return {
        ...state,
        dataShowTimesByCinemas: action.payload.data,
        isLoading: false,
      };
    case GET_SHOWTIMESBY_CINEMAS_FAILURE:
      return { ...state, isLoading: false, error: action.payload.error };
    //
    case GET_SHOWTIMESBY_MOVIE_REQUEST:
      return { ...state, isLoading: true, error: null };
    case GET_SHOWTIMESBY_MOVIE_SUCCESS:
      return {
        ...state,
        dataShowTimesByMovie: action.payload.data,
        isLoading: false,
      };
    case GET_SHOWTIMESBY_MOVIE_FAILURE:
      return { ...state, isLoading: false, error: action.payload.error };
    //
    default:
      return state;
