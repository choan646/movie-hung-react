...
const cinemasAPI = {
  ...
  getCumRapByCinemas: (maHeThongRap) => {
    return axiosClient.get(
      `/QuanLyRap/LayThongTinCumRapTheoHeThong?maHeThongRap=${maHeThongRap}&maNhom=GP11`
    );
  },
  getShowTimesByCinemas: (maHeThongRap) => {
    return axiosClient.get(
      `/QuanLyRap/LayThongTinLichChieuHeThongRap?maHeThongRap=${maHeThongRap}&maNhom=GP11`
    );
  },
